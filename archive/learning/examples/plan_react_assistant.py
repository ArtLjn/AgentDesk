...
使用方法：
    python archive/learning/examples/plan_react_assistant.py
...
from archive.learning.basic_agents.plan_react_agent import PlanReactAgent, _sanitize_text
...
def main() -> None:
    ...
    logger.add(
        "archive/learning/logs/plan_react_assistant_{time:YYYY-MM-DD}.log",
        level="DEBUG",
        rotation="10 MB",
        retention="7 days",
        encoding="utf-8",
