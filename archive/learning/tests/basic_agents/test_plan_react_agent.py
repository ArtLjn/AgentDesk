...
from archive.learning.basic_agents.plan_react_agent import PlanReactAgent
...
class TestPlanReactAgent:
    ...
    def test_create_plan_parsing(self) -> None:
        ...
        with patch("archive.learning.basic_agents.plan_react_agent.OpenAI") as mock_openai:
